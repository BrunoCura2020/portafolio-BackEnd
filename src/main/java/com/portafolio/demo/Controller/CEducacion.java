...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion = new Educacion(dtoeducacion.getNombre(), dtoeducacion.getCarrera(), dtoeducacion.getTitulo(), dtoeducacion.getInicio(), dtoeducacion.getFin());
...
@PutMapping("/update/{id}")
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        if(sEducacion.existsByNombre(dtoeducacion.getNombre()) && sEducacion.getByNombreEdu(dtoeducacion.getNombre()).get().getId() != id)
            return new ResponseEntity(new Mensaje("Esa experiencia ya existe"), HttpStatus.BAD_REQUEST);
